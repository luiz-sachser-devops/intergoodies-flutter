...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color imperialRed = Color(0xFFED3D3D);
  late Color lightOrange = Color(0xFFFFD6AF);
  late Color iceBlue = Color(0xFF9DFFF9);
  late Color roseQuartz = Color(0xFFAC9FBB);
  late Color wisteria = Color(0xFFCB9CF2);
}
