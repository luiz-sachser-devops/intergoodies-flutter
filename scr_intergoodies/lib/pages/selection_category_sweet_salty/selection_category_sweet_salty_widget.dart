...
import 'selection_category_sweet_salty_model.dart';
export 'selection_category_sweet_salty_model.dart';

class SelectionCategorySweetSaltyWidget extends StatefulWidget {
  const SelectionCategorySweetSaltyWidget({
    Key? key,
  ...
  @override
  _SelectionCategorySweetSaltyWidgetState createState() =>
      _SelectionCategorySweetSaltyWidgetState();
}

class _SelectionCategorySweetSaltyWidgetState
    extends State<SelectionCategorySweetSaltyWidget>
    with TickerProviderStateMixin {
  late SelectionCategorySweetSaltyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectionCategorySweetSaltyModel());
                                              ...
                                              child: Container(
                                                ...
                                                child: CachedNetworkImage(
                                                  imageUrl: getJsonField(
                                                    FFAppState().database,
                                                    r'''$.MainCategories[0].children[1].children[1].image_path''',
                                                  ),
                                            ...
                                            child: Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: CachedNetworkImage(
                                                  imageUrl: getJsonField(
                                                    FFAppState().database,
                                                    r'''$.MainCategories[0].children[1].children[0].image_path''',
                                                  ),
                                                  width: MediaQuery.of(context)
                                                          .size
                                                          .width *
