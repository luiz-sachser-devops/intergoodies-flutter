...
import 'selection_country_model.dart';
export 'selection_country_model.dart';

class SelectionCountryWidget extends StatefulWidget {
  const SelectionCountryWidget({Key? key}) : super(key: key);

  @override
  _SelectionCountryWidgetState createState() => _SelectionCountryWidgetState();
}

class _SelectionCountryWidgetState extends State<SelectionCountryWidget>
    with TickerProviderStateMixin {
  late SelectionCountryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectionCountryModel());
