...
import 'selection_category_type_model.dart';
export 'selection_category_type_model.dart';

class SelectionCategoryTypeWidget extends StatefulWidget {
  const SelectionCategoryTypeWidget({
    Key? key,
  ...
  @override
  _SelectionCategoryTypeWidgetState createState() =>
      _SelectionCategoryTypeWidgetState();
}

class _SelectionCategoryTypeWidgetState
    extends State<SelectionCategoryTypeWidget> with TickerProviderStateMixin {
  late SelectionCategoryTypeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectionCategoryTypeModel());
                                              ...
                                              child: Container(
                                                ...
                                                child: CachedNetworkImage(
                                                  imageUrl: getJsonField(
                                                    FFAppState().database,
                                                    r'''$.MainCategories[0].children[1].image_path''',
                                                  ),
                                            ...
                                            child: Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: CachedNetworkImage(
                                                  imageUrl: getJsonField(
                                                    FFAppState().database,
                                                    r'''$.MainCategories[0].children[0].image_path''',
                                                  ),
                                                  width: MediaQuery.of(context)
                                                          .size
                                                          .width *
